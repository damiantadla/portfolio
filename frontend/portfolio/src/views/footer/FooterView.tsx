...
const LineSvg = () => {
    return (
        <svg className="my-10" xmlns="http://www.w3.org/2000/svg" width="1300" height="3" viewBox="0 0 1300 3" fill="none">
...
const FooterView = () => {
    return (
        <section className="h-[685px] bg-[#272727] rounded-t-[20px] text-[#FCFCFD]">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between py-16 ">
                    <h1 className="text-6xl font-semibold">
                        Lets Connect there
                    </h1>
                    <button className="flex w-[202px] items-center justify-center bg-orange px-[20px] py-[10px] rounded-[60px]">
                        <p className="text-2xl">Hire me</p>
                        <svg width="43" height="43" viewBox="0 0 43 43" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.75 29.8311L30.25 12.3311" stroke="white" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path d="M12.75 12.3311H30.25V29.8311" stroke="white" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round"/>
                    </svg>
                    </button>
                </div>
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        <h2 className="text-orange mb-4">Get the latest information</h2>
                        <div className="flex">
