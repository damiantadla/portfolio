...
const SectionResults = () => {
    ...
    return (
        <section className="relative h-[70vh] bg-[rgba(0,0,0,0.5)] rounded-[40px] z-10">
            <div
                className="absolute inset-0 rounded-[40px] bg-back-pattern bg-center bg-cover bg-no-repeat z-0 text-white">
                <div className="flex flex-col items-center justify-center mt-28">
                    <div className="mx-auto text-center">
                        <h1 className="text-5xl font-normal w-[448px] mx-auto">
                            Testimonials That Speak to <span className="text-orange">My Results</span>
                        </h1>
                        <p className="w-[724px] mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed congue interdum ligula a
                    ...
                    >
                        {slidesData.map((slide, index) => (
                            <SwiperSlide key={index}>
                                <div
                                    className="flex flex-col w-full h-[240px] bg-white bg-opacity-15 text-white mt-20 rounded-[24px]">
                                    ...
                                    <div className="flex justify-between m-4">
                                        ...
                                        <svg width="60" height="60" viewBox="0 0 128 129"
                                             fill="none"
                                    ...
                                    <p className="text-start m-3">{slide.description}</p>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
