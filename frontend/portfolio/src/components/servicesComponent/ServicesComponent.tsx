const ServicesComponent = () => {
    return (
        <div style={{ position: 'relative', width: '417px', height: '508px', borderRadius: '20px', overflow: 'hidden' }}>
            {/* Div with rounded corners */}

            {/* SVG with the image */}
            <svg xmlns="http://www.w3.org/2000/svg" width="417" height="508" viewBox="0 0 417 508" fill="none">
                <defs>
